module EDPftvarcon
  ...
  type, public ::  EDPftvarcon_type
     ...
     real(r8), allocatable :: freezetol(:)           ! minimum temperature tolerance, post-hardened trees
     real(r8), allocatable :: freezetol_seedling(:)  ! [JStenzel 2.7.2022] Minimum temperature tolerance, pre-hardened seedlings
     ...
     real(r8), allocatable :: heat_tol_seedling(:)   ! [JStenzel 2.7.2022] maximum temperature tolerance, pre-hardened seedlings 
     real(r8), allocatable :: heat_tol(:)            ! [JStenzel 2.7.2022] maximum temperature tolerance, post-hardened trees
     real(r8), allocatable :: hard_dbh(:)            ! [JStenzel 2.7.2022] minimum dbh above which non-seedling mortality occurs
     real(r8), allocatable :: temp_delay(:)          ! [JStenzel 2.7.2022] Delay in timesteps of temperature based mortality (heat, freeze)
...
contains
  ...
  subroutine FatesReportPFTParams(is_master)
	...
	write(fates_log(),fmt0) 'temp_delay = ',EDPftvarcon_inst%temp_delay
