module EDParamsMod
   ...
   integer, public :: maxpatch_tertiary
   character(len=param_string_length), parameter, public :: maxpatch_tertiary_name = "fates_maxpatch_tertiary" ![JStenzel edit ] !~~
...
contains
  ...
  subroutine FatesParamsInit()
    ...
    maxpatch_tertiary                     = -9  ![JStenzel edit] !~~
  ...
  subroutine FatesRegisterParams(fates_params)
    ...
    call fates_params%RegisterParameter(name=maxpatch_tertiary_name, dimension_shape=dimension_shape_scalar, &   ![JStenzel edit] !~~
         dimension_names=dim_names_scalar)
  ...
  subroutine FatesReceiveParams(fates_params)
    ...
    call fates_params%RetrieveParameter(name=maxpatch_tertiary_name, &   ![JStenzel edit] !~~
         data=tmpreal)
    maxpatch_tertiary = nint(tmpreal)

    maxpatch_total = maxpatch_primary+maxpatch_secondary+maxpatch_tertiary  ![JStenzel edit] !~~
    ...
    call fates_params%RetrieveParameter(name=name_temp_delay, &
          data=temp_delay)
  ...
  subroutine FatesReportParams(is_master)
     ...
     if(debug_report .and. is_master) then
        ...
        write(fates_log(),fmt0) 'temp_delay = ',temp_delay
